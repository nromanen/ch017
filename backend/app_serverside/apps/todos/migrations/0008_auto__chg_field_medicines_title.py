...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Medicines.title'
        db.alter_column(u'todos_medicines', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Medicines.title'
        db.alter_column(u'todos_medicines', 'title', self.gf('django.db.models.fields.TextField')())
